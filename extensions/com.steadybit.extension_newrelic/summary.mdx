...
Furthermore, you can [get a dashboard](https://github.com/steadybit/extension-newrelic/tree/main/dashboard) to see amount of experiment executions in your Dynatrace environment.
