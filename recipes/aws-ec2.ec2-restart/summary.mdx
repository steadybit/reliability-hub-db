...
We validate whether an exposed [HTTP endpoint](http://k8s.demo.steadybit.io/products) works with a success rate of at least 95% while restarting one of the EC2 instances.
