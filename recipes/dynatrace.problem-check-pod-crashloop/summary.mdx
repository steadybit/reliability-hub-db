...
First, check that Dynatrace doesn't have any problems for an entity and doesn't alert already on non-ready containers.
...
The Kubernetes deployment `hot-deals` consists of two pods.
