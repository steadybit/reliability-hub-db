...
Note that this action will not differentiate between bare-metal or virtual machines. It will always attempt to shut down/reboot a host using the abovementioned strategy.
