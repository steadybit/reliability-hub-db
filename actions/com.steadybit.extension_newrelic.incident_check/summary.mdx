...
| Entity Tag Filter        | (optional) Filter Incidents based on tags of their related entities            |                               |
| Condition                | If you pick a condition, the experiment will fail if the condition is not met. | No check, only show incidents |
| Condition Check Mode     | How often should the status be expected. "At least once" or "All the time"     | allTheTime                    |
