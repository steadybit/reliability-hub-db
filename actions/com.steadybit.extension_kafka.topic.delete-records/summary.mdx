...
|--------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------|
| X from newest Offset                       | How many records to keep relative to the newest offset. `0` means advance to the latest offset, skipping all records. `10` means keep the 10 most recent records and delete everything before them. This is applied per partition. | 0       |
