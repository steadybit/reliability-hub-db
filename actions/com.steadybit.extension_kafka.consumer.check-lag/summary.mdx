...
|---------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------|
| Duration            | How long the check runs. Consumer lag is polled continuously for this duration.                                                                                                                                                | 30s     |
...
| Lag alert threshold | Required. The maximum acceptable offset difference between the topic's latest offset and the consumer group's committed offset. If lag exceeds this value, the experiment fails. Specified as an integer (number of messages). | 10      |
