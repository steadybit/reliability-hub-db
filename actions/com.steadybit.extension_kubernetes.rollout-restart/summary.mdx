...
|---------------------------------|------------------------------------------------------------------------------------|---------|
| Wait for rollout completion     | (optional) Whether to wait for the rollout to complete before completing the step. | false   |
| Fail on already running rollout | (optional) Whether to fail if a rollout is already in progress.                    | true    |
