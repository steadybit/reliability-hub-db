...
| Check type | How should the node count change? (See values below)                | actual count >= node count |
| Node count | How many nodes are required or should change to let the check pass? | 1                          |
