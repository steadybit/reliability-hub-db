...
This action leverages [steadybit/failure-azure-functions-net](https://github.com/steadybit/failure-azure-functions-net) and the Azure App Configuration to fill the tmp disk of an ASP.NET application.

# Use Cases

- Understand how an ASP.NET application behaves when it pollutes the tmp directory.
...
| Megabytes To Fill | Size in MB of the file created in tmp.                                            | 10      |
