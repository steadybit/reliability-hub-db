...
This action leverages [steadybit/failure-azure-functions-net](https://github.com/steadybit/failure-azure-functions-net) and the Azure App Configuration to fill the tmp disk of an azure function.

# Use Cases

- Understand how a azure function behaves when it pollutes the tmp directory

# Prerequisites

Azure Function must be using v4 isolated worker model and .NET 8 or higher.

Azure Function must not use ASP.NET abstractions.
