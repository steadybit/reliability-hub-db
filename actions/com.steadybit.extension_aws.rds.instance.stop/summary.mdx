...
As it is not possible to stop instances of Multi-AZ clusters, please use the [Trigger DB Cluster Failover](/action/com.steadybit.extension_aws.rds.cluster.failover) action instead.
...
Note that this attack does not support any rollback. The attack triggers the stop via API. The stop can't be canceled.
