...
This action leverages [steadybit/failure-azure-functions-net](https://github.com/steadybit/failure-azure-functions-net) and the Azure App Configuration to inject an exception into an Azure Function application.

# Use Cases

- Understand how an Azure Function application behaves when it encounters an exception.
