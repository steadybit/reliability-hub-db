...
This action injects exceptions into AWS Lambdas function executions.
...
- Validate behavior of upstream services and monitoring systems when Lambda functions return errors
- Test error propagation and handling across distributed systems
...
| Message   | Exception message thrown during execution                             | Injected exception |
