...
If you specify a usage that exceeds the total memory (e.g. > 100%) it fills up the memory as much as possible until the process is oomkilled.
...
| Fail on OOM Kill | Should it be treated as a failure then the attacked container was oomkilled?                                                                                                                                                                  | False                         |
